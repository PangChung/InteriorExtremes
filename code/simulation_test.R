...
system.time( fit.logskew <- fit.model(data=Z.logskew,loc=coord,init=c(0.5,1,2),fixed=c(F,F,F),thres=0.9,model="logskew",method="L-BFGS-B",lb=c(0.1,0.1,-Inf),ub=c(10,1.9,Inf),ncores=10,maxit=10000) )
