...
Rscript code/application_florida.R "computer=\"hpc\";idx.jack=${PBS_ARRAY_INDEX};method=\"L-BFGS-B\";id=${id}" 
# Rscript code/application_florida.R "computer=\"hpc\";idx.jack=0;method=\"L-BFGS-B\";id=${PBS_ARRAY_INDEX}" 
