...
ind = c(210,224)
par.skew.list[[1]] <- alpha2delta(list(vario.func(coord,par.skew.normal[1,idx.para]),alpha.func(par=par.skew.normal[1,-idx.para],b.mat=basis)))
par.skew.list[[1]] <- list(par.skew.list[[1]][[1]][ind,ind],par.skew.list[[1]][[2]][ind])
par.skew.list[[2]] <- alpha2delta(list(vario.func(coord,c(1,1.9)),alpha.func(par=par.skew.normal[1,-idx.para],b.mat=basis)))
par.skew.list[[2]] <- list(par.skew.list[[2]][[1]][ind,ind],par.skew.list[[2]][[2]][ind])

data=samples.skew.normal[[1]][,ind]
